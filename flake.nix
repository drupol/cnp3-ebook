  ...
  outputs = { self, nixpkgs, flake-utils, nixpkgs-pydata-sphinx-theme, ... }@inputs:
    with flake-utils.lib; eachSystem allSystems (system:
      let
        ...
        # mscgen custom derivation see https://github.com/NixOS/nixpkgs/pull/192650
        ...
        sphinx-build =
          let
            # We must use an older nixpkgs overlay because of sphinx-book-theme
            # sphinx-book-theme does not currently support Sphinx > 5
